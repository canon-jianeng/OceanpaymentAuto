...
class TestCheck(unittest.TestCase):
    ...
    @ddt.data(*Exc(AutoCheck().read_data("check"), "check").read_merged())
    ...
    @ddt.data(*Exc(AutoCheck().read_data("check"), "track").read_merged())
    ...
    @ddt.data(*Exc(AutoCheck().read_data("check"), "refund").read_merged())
