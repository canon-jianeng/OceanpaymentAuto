...
class TestGateway(unittest.TestCase):
    ...
    @ddt.data(*Exc(Gateway().read_path("xlsx", "pay"), "ThreePay").read_merged())
    ...
    @ddt.data(*Exc(Gateway().read_path("xlsx", "pay"), "ThreeQuick").read_merged())
    ...
    @ddt.data(*Exc(Gateway().read_path("xlsx", "pay"), "TwoPay").read_merged())
    ...
    @ddt.data(*Exc(Gateway().read_path("xlsx", "pay"), "TwoQuick").read_merged())
    ...
    @ddt.data(*Exc(Gateway().read_path("xlsx", "pay"), "TwoHalfPay").read_merged())
    ...
    @ddt.data(*Exc(Gateway().read_path("xlsx", "pay"), "TwoHalfQuick").read_merged())
    ...
    @ddt.data(*Exc(Gateway().read_path("xlsx", "moto"), "Moto").read_merged())
